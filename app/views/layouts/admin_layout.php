...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .search-kbd {
            background: #e8e6df; border-radius: 4px;
            padding: 1px 5px; font-size: 10px; font-weight: 600; color: #888;
        }
        .topbar-avatar {
        ...
        .modal-title { font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; font-size: 16px; letter-spacing: -0.3px; }
        .modal-close {
        ...
        .form-label { font-size: 10px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: #888; }
        .form-input {
        ...
        .modal-footer { padding: 8px 24px 20px; }
        .btn-submit {
            width: 100%; padding: 11px; background: var(--accent); color: #fff;
            border: none; border-radius: 10px; font-size: 13px; font-weight: 700;
            cursor: pointer; font-family: 'Plus Jakarta Sans', sans-serif; transition: background .12s;
        }
...
<body>
    ...
    <aside class="sidebar" id="appSidebar">
        <div class="sidebar-logo flex items-center justify-between">
            <a href="<?= APP_URL ?>/admin/settings" class="flex items-center gap-2 group">
        ...
        $mainNav = [
            ['icon' => 'fa-house',           'url' => '/admin',               'label' => 'Admin Home',    'match' => '#/admin$#'],
            ['icon' => 'fa-book-open',       'url' => '/admin/courses',       'label' => 'Classes',       'match' => '#/admin/courses#'],
            ['icon' => 'fa-user-graduate',   'url' => '/admin/students',      'label' => 'Students',      'match' => '#/admin/students#'],
            ['icon' => 'fa-chalkboard-user', 'url' => '/admin/teachers',      'label' => 'Teachers',      'match' => '#/admin/teachers#'],
            ['icon' => 'fa-calendar-days',   'url' => '/admin/schedules',     'label' => 'Class Schedule','match' => '#/admin/schedules#'],
            ['icon' => 'fa-file-invoice',    'url' => '/admin/slips',         'label' => 'Payment Slips', 'match' => '#/admin/slips#'],
            ['icon' => 'fa-chart-line',      'url' => '/admin/earnings',      'label' => 'Income',        'match' => '#/admin/earnings#'],
            ['icon' => 'fa-bell',            'url' => '/admin/notifications', 'label' => 'Messages',      'match' => '#/admin/notifications#'],
            ['icon' => 'fa-shield-halved',   'url' => '/admin/admins',        'label' => 'Admins',        'match' => '#/admin/admins#'],
        ];
        ...
        <a href="<?= APP_URL ?>/admin/settings" class="nav-item <?= strpos($curr, '/admin/settings') !== false ? 'active' : '' ?>">
    ...
    <div class="main">
        <header class="topbar">
            <div class="flex items-center gap-3">
                ...
                <span class="topbar-title hidden sm:block"><?= htmlspecialchars($title ?? 'Dashboard') ?></span>
                <span class="topbar-title sm:hidden text-lg"><?= htmlspecialchars($title ?? 'Admin') ?></span>
            </div>
            <div class="topbar-right">
                ...
                <span class="topbar-welcome hidden md:block">Hello, <strong><?= htmlspecialchars($user['name'] ?? 'Admin') ?></strong></span>
