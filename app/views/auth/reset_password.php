<div class="auth-card rounded-[1.5rem] md:rounded-[2rem] p-6 sm:p-8 md:p-10 lg:p-14">
    <div class="text-center mb-10">
        <h2 class="text-3xl font-black syne-font text-emerald-600 mb-2">Reset Password</h2>
        <p class="text-emerald-600/60 text-sm font-medium uppercase tracking-widest text-[10px]">Finalize Key Update</p>
    </div>
    ...
    <form method="POST" action="<?= APP_URL ?>/reset-password" class="space-y-6">
        <div class="space-y-2">
            <label class="text-[10px] font-bold text-emerald-600 uppercase tracking-[0.15em] ml-2">New Password</label>
